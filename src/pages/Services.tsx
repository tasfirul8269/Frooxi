        ...
        <div className="container">
          <div className="max-w-3xl mx-auto text-center">
            ...
            <p className="text-xl opacity-90 mb-8">
              Contact us today to schedule a consultation and learn how we can help you achieve your digital objectives.
            </p>
            <a 
              href="/contact" 
              className="inline-block px-8 py-3 bg-background text-foreground font-medium rounded-full hover:bg-background/90 transition-colors"
            >
              Get in Touch
            </a>
          </div>
